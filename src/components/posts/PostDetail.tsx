    ...
    <div className="post_details-container">
        <div className="post_details-card">
            <div className="relative post_details-img">
                <Image className="post_details-img" src={post.imageUrl} fill alt={post.caption} />
            </div>
            <div className="post_details-info">
                <Link href={`${Routes.Profile}/${post.creator?.id}`} className='flex items-center justify-between w-full gap-3'>
                    ...
                    <div className="flex items-center ml-auto">
                        ...
                        <Button variant='ghost' className="rounded-full p-3" onClick={(e) => handleDelete(e)}>
                            <MdDelete size={30} className="text-primary-500 hover:text-red" />
                        </Button>
                    </div>}
                </Link>
